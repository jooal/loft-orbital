...
export type UpdateReportMutation = { __typename?: 'Mutation', updateReport: { __typename?: 'Report', id: string, title: string, type: string, date: any, satellite_id: string | null, employee_id: string, Satellite: { __typename?: 'Satellite', id: string, name: string } | null, Comments: Array<{ __typename?: 'Comment', id: string, date: any, content: string, employee_id: string, Employee: { __typename?: 'Employee', name: string } | null } | null> | null, Employee: { __typename?: 'Employee', id: string, name: string } | null, GroundStation: { __typename?: 'GroundStation', id: string, name: string, coordinates: Array<number | null>, status: string, network: string, Contacts: Array<{ __typename?: 'Contact', id: string, date: any, type: string, executionScript: string } | null> | null } | null } | null };
...
export type CreateReportMutation = { __typename?: 'Mutation', createReport: { __typename?: 'Report', id: string, title: string, type: string, date: any, satellite_id: string | null, employee_id: string, Satellite: { __typename?: 'Satellite', id: string, name: string } | null, Comments: Array<{ __typename?: 'Comment', id: string, date: any, content: string, employee_id: string, Employee: { __typename?: 'Employee', name: string } | null } | null> | null, Employee: { __typename?: 'Employee', id: string, name: string } | null, GroundStation: { __typename?: 'GroundStation', id: string, name: string, coordinates: Array<number | null>, status: string, network: string, Contacts: Array<{ __typename?: 'Contact', id: string, date: any, type: string, executionScript: string } | null> | null } | null } | null };
...
export type DeleteReportMutation = { __typename?: 'Mutation', removeReport: { __typename?: 'Report', id: string } | null };
...
export type CreateCommentMutation = { __typename?: 'Mutation', createComment: { __typename?: 'Comment', id: string, date: any, content: string, Report: { __typename?: 'Report', id: string } | null, Employee: { __typename?: 'Employee', id: string, name: string } | null } | null };
...
export type GetSatellitesQuery = { __typename?: 'Query', allSatellites: Array<{ __typename?: 'Satellite', id: string, name: string, status: string, description: string, Payloads: Array<{ __typename?: 'Payload', id: string } | null> | null } | null> | null };
...
export type GetFilteredSatellitesQuery = { __typename?: 'Query', allSatellites: Array<{ __typename?: 'Satellite', id: string, name: string, status: string, description: string, Payloads: Array<{ __typename?: 'Payload', id: string } | null> | null } | null> | null };

export type DashboardDataQueryVariables = Exact<{ [key: string]: never; }>;


export type DashboardDataQuery = { __typename?: 'Query', allSatellites: Array<{ __typename?: 'Satellite', id: string, name: string, status: string, coordinates: Array<number | null> } | null> | null, allConstellations: Array<{ __typename?: 'Constellation', id: string, name: string, Satellites: Array<{ __typename?: 'Satellite', id: string, name: string } | null> | null } | null> | null };
...
export type GetSatelliteDetailsQuery = { __typename?: 'Query', allSatellites: Array<{ __typename?: 'Satellite', id: string, name: string, status: string, image: string, description: string, busType: string, manufacturer: string, coordinates: Array<number | null>, altitude: number, Payloads: Array<{ __typename?: 'Payload', id: string, name: string, description: string, status: string, category: string, configuration: any, Customer: { __typename?: 'Customer', id: string, name: string } | null } | null> | null, Launch: { __typename?: 'Launch', id: string, date: any, status: string, outcome: string | null, provider: string, rocket: string } | null } | null> | null };

export type GetAllReportsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllReportsQuery = { __typename?: 'Query', allReports: Array<{ __typename?: 'Report', id: string, title: string, type: string, date: any, Satellite: { __typename?: 'Satellite', id: string, name: string } | null, Comments: Array<{ __typename?: 'Comment', id: string } | null> | null, GroundStation: { __typename?: 'GroundStation', id: string, name: string } | null } | null> | null };

export type GetCreateReportFormDataQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCreateReportFormDataQuery = { __typename?: 'Query', allGroundStations: Array<{ __typename?: 'GroundStation', id: string, name: string } | null> | null, allSatellites: Array<{ __typename?: 'Satellite', id: string, name: string } | null> | null, allEmployees: Array<{ __typename?: 'Employee', id: string, name: string } | null> | null };

export type GetAllEmployeesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllEmployeesQuery = { __typename?: 'Query', allEmployees: Array<{ __typename?: 'Employee', id: string } | null> | null };
...
export type GetReportDetailsQuery = { __typename?: 'Query', allReports: Array<{ __typename?: 'Report', id: string, title: string, type: string, date: any, content: string, satellite_id: string | null, employee_id: string, Satellite: { __typename?: 'Satellite', id: string, name: string, image: string, status: string } | null, Comments: Array<{ __typename?: 'Comment', id: string, date: any, content: string, employee_id: string, Employee: { __typename?: 'Employee', name: string } | null } | null> | null, Employee: { __typename?: 'Employee', id: string, name: string } | null, GroundStation: { __typename?: 'GroundStation', id: string, name: string, coordinates: Array<number | null>, status: string, network: string, Contacts: Array<{ __typename?: 'Contact', id: string, date: any, type: string, executionScript: string } | null> | null } | null } | null> | null };


export const UpdateReportDocument = gql`
    mutation UpdateReport($id: ID!, $type: String, $date: Date, $title: String, $content: String, $satellite_id: ID, $employee_id: ID, $groundStation_id: ID) {
  updateReport(
    id: $id
    type: $type
    date: $date
...
export const CreateReportDocument = gql`
    mutation CreateReport($type: String!, $date: Date!, $title: String!, $content: String!, $satellite_id: ID, $employee_id: ID!, $groundStation_id: ID) {
  createReport(
    type: $type
    date: $date
    title: $title
...
export const CreateCommentDocument = gql`
    mutation CreateComment($date: Date!, $content: String!, $employee_id: ID!, $report_id: ID!) {
  createComment(
    date: $date
    content: $content
    employee_id: $employee_id
...
export const GetSatellitesDocument = gql`
    query GetSatellites($page: Int, $perPage: Int, $sortField: String, $sortOrder: String) {
  allSatellites(
    page: $page
    perPage: $perPage
    sortField: $sortField
 ...
 * });
 */
export function useGetSatellitesQuery(baseOptions?: Apollo.QueryHookOptions<GetSatellitesQuery, GetSatellitesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSatellitesQuery, GetSatellitesQueryVariables>(GetSatellitesDocument, options);
      }
export function useGetSatellitesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSatellitesQuery, GetSatellitesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSatellitesQuery, GetSatellitesQueryVariables>(GetSatellitesDocument, options);
        }
export function useGetSatellitesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetSatellitesQuery, GetSatellitesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetSatellitesQuery, GetSatellitesQueryVariables>(GetSatellitesDocument, options);
        }
export type GetSatellitesQueryHookResult = ReturnType<typeof useGetSatellitesQuery>;
export type GetSatellitesLazyQueryHookResult = ReturnType<typeof useGetSatellitesLazyQuery>;
export type GetSatellitesSuspenseQueryHookResult = ReturnType<typeof useGetSatellitesSuspenseQuery>;
export type GetSatellitesQueryResult = Apollo.QueryResult<GetSatellitesQuery, GetSatellitesQueryVariables>;
export const GetFilteredSatellitesDocument = gql`
    query GetFilteredSatellites($page: Int, $perPage: Int, $sortField: String, $sortOrder: String, $status: String) {
  allSatellites(
    page: $page
    perPage: $perPage
    sortField: $sortField
 ...
 * });
 */
export function useGetFilteredSatellitesQuery(baseOptions?: Apollo.QueryHookOptions<GetFilteredSatellitesQuery, GetFilteredSatellitesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetFilteredSatellitesQuery, GetFilteredSatellitesQueryVariables>(GetFilteredSatellitesDocument, options);
      }
export function useGetFilteredSatellitesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetFilteredSatellitesQuery, GetFilteredSatellitesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetFilteredSatellitesQuery, GetFilteredSatellitesQueryVariables>(GetFilteredSatellitesDocument, options);
        }
export function useGetFilteredSatellitesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetFilteredSatellitesQuery, GetFilteredSatellitesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetFilteredSatellitesQuery, GetFilteredSatellitesQueryVariables>(GetFilteredSatellitesDocument, options);
        }
export type GetFilteredSatellitesQueryHookResult = ReturnType<typeof useGetFilteredSatellitesQuery>;
export type GetFilteredSatellitesLazyQueryHookResult = ReturnType<typeof useGetFilteredSatellitesLazyQuery>;
export type GetFilteredSatellitesSuspenseQueryHookResult = ReturnType<typeof useGetFilteredSatellitesSuspenseQuery>;
export type GetFilteredSatellitesQueryResult = Apollo.QueryResult<GetFilteredSatellitesQuery, GetFilteredSatellitesQueryVariables>;
 ...
 * });
 */
export function useGetSatelliteDetailsQuery(baseOptions: Apollo.QueryHookOptions<GetSatelliteDetailsQuery, GetSatelliteDetailsQueryVariables> & ({ variables: GetSatelliteDetailsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSatelliteDetailsQuery, GetSatelliteDetailsQueryVariables>(GetSatelliteDetailsDocument, options);
      }
export function useGetSatelliteDetailsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSatelliteDetailsQuery, GetSatelliteDetailsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSatelliteDetailsQuery, GetSatelliteDetailsQueryVariables>(GetSatelliteDetailsDocument, options);
        }
export function useGetSatelliteDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetSatelliteDetailsQuery, GetSatelliteDetailsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetSatelliteDetailsQuery, GetSatelliteDetailsQueryVariables>(GetSatelliteDetailsDocument, options);
        }
export type GetSatelliteDetailsQueryHookResult = ReturnType<typeof useGetSatelliteDetailsQuery>;
export type GetSatelliteDetailsLazyQueryHookResult = ReturnType<typeof useGetSatelliteDetailsLazyQuery>;
export type GetSatelliteDetailsSuspenseQueryHookResult = ReturnType<typeof useGetSatelliteDetailsSuspenseQuery>;
export type GetSatelliteDetailsQueryResult = Apollo.QueryResult<GetSatelliteDetailsQuery, GetSatelliteDetailsQueryVariables>;
 ...
 * });
 */
export function useGetCreateReportFormDataQuery(baseOptions?: Apollo.QueryHookOptions<GetCreateReportFormDataQuery, GetCreateReportFormDataQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCreateReportFormDataQuery, GetCreateReportFormDataQueryVariables>(GetCreateReportFormDataDocument, options);
      }
export function useGetCreateReportFormDataLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCreateReportFormDataQuery, GetCreateReportFormDataQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCreateReportFormDataQuery, GetCreateReportFormDataQueryVariables>(GetCreateReportFormDataDocument, options);
        }
export function useGetCreateReportFormDataSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetCreateReportFormDataQuery, GetCreateReportFormDataQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetCreateReportFormDataQuery, GetCreateReportFormDataQueryVariables>(GetCreateReportFormDataDocument, options);
        }
export type GetCreateReportFormDataQueryHookResult = ReturnType<typeof useGetCreateReportFormDataQuery>;
export type GetCreateReportFormDataLazyQueryHookResult = ReturnType<typeof useGetCreateReportFormDataLazyQuery>;
export type GetCreateReportFormDataSuspenseQueryHookResult = ReturnType<typeof useGetCreateReportFormDataSuspenseQuery>;
export type GetCreateReportFormDataQueryResult = Apollo.QueryResult<GetCreateReportFormDataQuery, GetCreateReportFormDataQueryVariables>;
 ...
 * });
 */
export function useGetReportDetailsQuery(baseOptions: Apollo.QueryHookOptions<GetReportDetailsQuery, GetReportDetailsQueryVariables> & ({ variables: GetReportDetailsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetReportDetailsQuery, GetReportDetailsQueryVariables>(GetReportDetailsDocument, options);
      }
export function useGetReportDetailsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetReportDetailsQuery, GetReportDetailsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetReportDetailsQuery, GetReportDetailsQueryVariables>(GetReportDetailsDocument, options);
        }
export function useGetReportDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetReportDetailsQuery, GetReportDetailsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetReportDetailsQuery, GetReportDetailsQueryVariables>(GetReportDetailsDocument, options);
        }
export type GetReportDetailsQueryHookResult = ReturnType<typeof useGetReportDetailsQuery>;
export type GetReportDetailsLazyQueryHookResult = ReturnType<typeof useGetReportDetailsLazyQuery>;
export type GetReportDetailsSuspenseQueryHookResult = ReturnType<typeof useGetReportDetailsSuspenseQuery>;
export type GetReportDetailsQueryResult = Apollo.QueryResult<GetReportDetailsQuery, GetReportDetailsQueryVariables>;